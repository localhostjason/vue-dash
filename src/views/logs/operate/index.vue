<template>
  <div>
    <el-row>
      <el-col :span="24">
        <panel-title title="操作日志" :is-line="isLine"></panel-title>
      </el-col>
    </el-row>
    ...
    <clear-log-modal type="operate" ref="clearLog" @getLogsList="getLogsList"></clear-log-modal>
  </div>
</template>
